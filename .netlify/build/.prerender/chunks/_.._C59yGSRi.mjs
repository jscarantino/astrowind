...
import { d as getStaticPathsBlogList, e as blogListRobots } from './blog_CAqKuImb.mjs';
...
` })} ${renderComponent($$result2, "BlogList", $$List, { "posts": page.data })} ${renderComponent($$result2, "Pagination", $$Pagination, { "prevUrl": page.url.prev, "nextUrl": page.url.next })} <!--
    ...
    --> </section> ` })}`;
}, "/Users/josefscarantino/Documents/_Josef.co/astrowind/src/pages/garden/[...blog]/[...page].astro", void 0);

const $$file = "/Users/josefscarantino/Documents/_Josef.co/astrowind/src/pages/garden/[...blog]/[...page].astro";
const $$url = "/garden/[...blog]/[...page]";
