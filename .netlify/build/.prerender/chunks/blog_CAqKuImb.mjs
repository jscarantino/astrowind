...
import { V as VALID_INPUT_FORMATS, c as createComponent, f as createSvgComponent, A as APP_BLOG, C as CATEGORY_BASE, T as TAG_BASE, B as BLOG_BASE, h as cleanSlug, P as POST_PERMALINK_PATTERN, t as trimSlash } from './consts_Lk1RniJ-.mjs';
import { removeBase, isRemotePath, prependForwardSlash } from '@astrojs/internal-helpers/path';
import { d as renderElement, A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, e as createHeadAndContent, r as renderComponent } from './prerender_N0dXcbyA.mjs';
import 'piccolore';
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CryG9Srd.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_DwdZXCaY.mjs');
