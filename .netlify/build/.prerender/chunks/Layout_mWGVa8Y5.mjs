import { c as createComponent, i as getAsset, f as createSvgComponent, U as UI, e as getCanonical, I as I18N, S as SITE, M as METADATA } from './consts_Y_N4nI3i.mjs';
import 'piccolore';
import { b as addAttribute, a as renderTemplate, f as defineScriptVars, r as renderComponent, F as Fragment, u as unescapeHTML, s as spreadAttributes, g as renderHead, c as renderSlot } from './prerender_BCITZfbm.mjs';
import 'clsx';
import merge from 'lodash.merge';
import { escape } from 'html-escaper';
import { g as getImage } from './_astro_assets_BmLuMCAg.mjs';
import { parseUrl, transformUrl } from 'unpic';
import { r as renderScript } from './script_u9Qkj1hv.mjs';
...
}, "/Users/josefscarantino/Documents/_Josef.co/astrowind/node_modules/.pnpm/@astrolib+seo@1.0.0-beta.8_astro@6.1.4_@netlify+blobs@10.7.4_@types+node@25.5.2_jiti@1._0063624edb2b8a00a396f2fd366937d6/node_modules/@astrolib/seo/src/AstroSeo.astro", void 0);
...
const load = async function() {
  let images = void 0;
  try {
    images = /* #__PURE__ */ Object.assign({"/src/assets/images/app-store.png": () => import('./app-store_MrASZIIe.mjs'),"/src/assets/images/default.png": () => import('./default_CYIan_vk.mjs'),"/src/assets/images/google-play.png": () => import('./google-play_CbQVenxx.mjs'),"/src/assets/images/hero-image.png": () => import('./hero-image_TOV4tSA1.mjs'),"/src/assets/images/logo.png": () => import('./logo_iBzpVNGv.mjs'),"/src/assets/images/logo.svg": () => import('./logo_ByLklJ33.mjs')});
  } catch (error) {
  }
  return images;
};
...
}, "/Users/josefscarantino/Documents/_Josef.co/astrowind/node_modules/.pnpm/@astrolib+analytics@0.6.1_astro@6.1.4_@netlify+blobs@10.7.4_@types+node@25.5.2_jiti@1.2_941ae5c2280ea4af69bd068b3712f0ee/node_modules/@astrolib/analytics/src/GoogleAnalytics.astro", void 0);

const $$Analytics = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${null}`;
}, "/Users/josefscarantino/Documents/_Josef.co/astrowind/src/components/common/Analytics.astro", void 0);
