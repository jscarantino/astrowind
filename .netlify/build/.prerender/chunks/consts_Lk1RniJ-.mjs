...
import { A as AstroError, I as InvalidComponentArgs, h as generateCspDigest, s as spreadAttributes, u as unescapeHTML, a as renderTemplate } from './prerender_N0dXcbyA.mjs';
import 'clsx';
...
const SITE = {"name":"Josef.co","site":"https://astrowind.vercel.app","base":"/","trailingSlash":false,"googleSiteVerificationId":"orcPxI47GSa-cRvY11tUe6iGg2IO_RPvnA1q95iEM3M"};
                    const I18N = {"language":"en","textDirection":"ltr"};
                    const METADATA = {"title":{"default":"AstroWind","template":"%s — AstroWind"},"description":"🚀 Suitable for Startups, Small Business, Sass Websites, Professional Portfolios, Marketing Websites, Landing Pages & Blogs.","openGraph":{"type":"website","site_name":"AstroWind","images":[{"url":"~/assets/images/default.png","width":1200,"height":628}]},"twitter":{"handle":"","site":"","cardType":"summary_large_image"}};
                    const APP_BLOG = {"postsPerPage":6,"post":{"permalink":"/%slug%","robots":{"index":true,"follow":true}},"list":{"pathname":"models","robots":{"follow":true}},"category":{"pathname":"category","robots":{"index":true,"follow":true}},"tag":{"pathname":"tag","robots":{"index":false,"follow":true}}};
